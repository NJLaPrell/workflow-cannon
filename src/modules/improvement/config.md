...
- `improvement.recommendations.heuristicVersion`: **`1`** (default; max-of-signals admission) or **`2`** (mean-of-signals with alternate threshold). **`heuristic_1`** remains the default when unset.
