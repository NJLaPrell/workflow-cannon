...
Read-only supervisor preflight for a worker handoff. Returns a bounded verdict packet so the orchestrator can decide whether reconciliation is safe without expanding raw diffs, full logs, or long-form handoff prose by default.
