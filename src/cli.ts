...
import { CANONICAL_KIT_NAME, defaultWorkspaceKitPaths } from "./cli/default-workspace-kit-paths.js";
import {
  currentOwnedPaths,
  pointerRuleContent,
  profileSchemaContent
} from "./cli/profile-baseline-content.js";
import {
  createDriftExpectedAssets,
  driftContentMatches,
  generateProfileDrivenArtifacts,
  parseJsonFile,
  readCliBundledPackageVersion,
  readOwnedPathsDocument,
