...
Read the rule index (R1–R19) at the top of the canonical file. Cite rules by ID (`R3.2`, `R8.4`, `R17.2`, `R19.4`, `R18.4`, etc.) in commit messages and PR reviews. Dashboard operator copy: **R19** (extends **R17**).
