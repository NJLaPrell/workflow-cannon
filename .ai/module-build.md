...
check|K105|scope=definition_of_done|assert=code_tests_docs_and_evidence_complete_for_assigned_task_scope|when=before_task_close|on_fail=warn|st=active|refs=.workspace-kit/tasks/state.json
