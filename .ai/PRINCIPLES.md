...
ref|name=tasks_queue|path=docs/maintainers/TASKS.md
...
rule|R001|must|repo|prioritize_safety_and_trustworthiness_first_in_tradeoffs|risk=critical|ap=required|ov=stop|st=active|refs=docs/maintainers/ROADMAP.md,docs/maintainers/TASKS.md
...
rule|R013|must|documentation_boundaries|keep_strategy_in_roadmap_execution_in_tasks_and_release_operations_in_releasing|risk=medium|ap=none|ov=warn|st=active|refs=docs/maintainers/ROADMAP.md,docs/maintainers/TASKS.md,docs/maintainers/RELEASING.md
...
rule|R015|must|principle_override|record_explicit_override_rationale_in_tasks_or_decisions|risk=medium|ap=prompt|ov=warn|st=active|refs=docs/maintainers/TASKS.md,docs/maintainers/DECISIONS.md
