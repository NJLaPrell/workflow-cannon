...
surface|S004|name=execution|paths=.workspace-kit/tasks/state.json|role=task_engine_queue_and_generated_human_view
...
term|goal|def=desired_project_outcome_for_evaluating_progress_and_direction|defined_in=.ai/PRINCIPLES.md,README.md|enforced_in=docs/maintainers/ROADMAP.md,.workspace-kit/tasks/state.json
...
term|playbook|def=reusable_strategy_for_a_class_of_work|defined_in=docs/maintainers/|enforced_in=.workspace-kit/tasks/state.json
...
term|evidence_requirement|def=minimum_proof_artifacts_for_valid_releasable_work|defined_in=docs/maintainers/RELEASING.md,.workspace-kit/tasks/state.json|enforced_in=release_checklist
