...
surface|S004|name=execution|path=docs/maintainers/TASKS.md|role=task_queue_and_dependencies
...
term|goal|def=desired_project_outcome_for_evaluating_progress_and_direction|defined_in=.ai/PRINCIPLES.md,README.md|enforced_in=docs/maintainers/ROADMAP.md,docs/maintainers/TASKS.md
...
term|playbook|def=reusable_strategy_for_a_class_of_work|defined_in=docs/maintainers/|enforced_in=docs/maintainers/TASKS.md
...
term|evidence_requirement|def=minimum_proof_artifacts_for_valid_releasable_work|defined_in=docs/maintainers/RELEASING.md,docs/maintainers/TASKS.md|enforced_in=release_checklist
