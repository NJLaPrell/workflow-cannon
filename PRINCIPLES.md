...
ref|name=tasks_queue|path=TASKS.md
ref|name=strategic_direction|path=ROADMAP.md
ref|name=decisions_log|path=DECISIONS.md
ref|name=release_workflow|path=RELEASING.md

rule|R001|must|repo|prioritize_safety_and_trustworthiness_first_in_tradeoffs|risk=critical|ap=required|ov=stop|st=active|refs=ROADMAP.md,TASKS.md
...
rule|R003|must|behavior_change|preserve_compatibility_or_provide_documented_migration_path|risk=high|ap=required|ov=stop|st=active|refs=RELEASING.md,CHANGELOG.md
rule|R004|must|release|produce_release_evidence_for_readiness_and_parity_checks|risk=high|ap=required|ov=stop|st=active|refs=RELEASING.md
...
rule|R013|must|documentation_boundaries|keep_strategy_in_roadmap_execution_in_tasks_and_release_operations_in_releasing|risk=medium|ap=none|ov=warn|st=active|refs=ROADMAP.md,TASKS.md,RELEASING.md
...
rule|R015|must|principle_override|record_explicit_override_rationale_in_tasks_or_decisions|risk=medium|ap=prompt|ov=warn|st=active|refs=TASKS.md,DECISIONS.md

check|K001|scope=release|assert=release_has_readiness_and_parity_evidence|when=before_release|on_fail=stop|st=active|refs=RELEASING.md
check|K002|scope=compatibility_changes|assert=migration_guidance_exists_for_compatibility_impact|when=before_merge_or_release|on_fail=stop|st=active|refs=CHANGELOG.md
