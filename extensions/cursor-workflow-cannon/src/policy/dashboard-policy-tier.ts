...
export const DASHBOARD_POLICY_TIER_MATRIX: readonly DashboardPolicyTierRow[] = [
  ...
  { workflowId: "ideas", action: "plan", command: "start-idea-planning", tier: "routine" },
  { workflowId: "ideas", action: "brainstorm", command: "start-brainstorm-session", tier: "routine" },
  ...
  { workflowId: "ideas", action: "check-delivery", command: "check-delivery-status", tier: "routine" },
