...
```json
{
  ...
  "packetDigest": "2dd755b20cf3389b0c37cb86f5778882b7e3916c3f212259a53be3b44e29d594",
  "contextProfileId": "task_worker_context_v1",
  "accessProfileId": "task_worker_strict_v1",
  "handoffContractId": "implementation_handoff_v2",
...
`packetDigest` is a stable SHA-256 over the persisted worker packet context (assignment ids plus normalized metadata). It must change when relevant task or assignment packet fields change.
