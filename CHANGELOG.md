...
Latest release: **v0.71.0** (Phase 71: CAE Guidance dashboard MVP, trace summaries, picker UX, explainability, and release-readiness evidence; see canonical changelog).
