...
| `improvement-scout` | [`playbooks/improvement-scout.md`](./playbooks/improvement-scout.md) | Bounded scout pass: lens rotation, evidence floor, read-only **`scout-report`** before persisting improvements |
