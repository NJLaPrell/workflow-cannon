<!-- GENERATED FROM .ai/workbooks/phase2-config-policy-workbook.md — edit that file; do not hand-edit this render (see docs/maintainers/ADR-ai-canonical-maintainer-docs-pipeline.md) -->
