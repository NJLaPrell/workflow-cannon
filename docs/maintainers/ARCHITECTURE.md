...
- **`defaultRegistryModules`** lists the shipped bundle: `workspace-config`, `documentation`, `agent-behavior`, `skills`, `subagents`, `team-execution`, `task-engine`, `approvals`, `planning`, `improvement` (see [`src/modules/README.md`](../../src/modules/README.md)).
